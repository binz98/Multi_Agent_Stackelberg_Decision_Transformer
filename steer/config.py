...
def get_config():
    ...
    Prepare parameters:
        --algorithm_name <algorithm_name>
            specifiy the algorithm, including `["steer", "steer_gru"]`
        --experiment_name <str>
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='steer', choices=["steer","steer_gru"])
    ...
    # add for different env config
    parser.add_argument("--add_state_token", action='store_true', default=False, help="by default, used for state+obs env.")
    return parser
