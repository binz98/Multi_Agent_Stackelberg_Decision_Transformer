...
from envs.highway.highwayEnv import Highway_Env as Env
...
class SubprocVecEnv(object):
    def __init__(self, all_args):
        ...
        self.env_list = [Env(all_args, i) for i in range(all_args.n_rollout_threads)]
...
class DummyVecEnv(object):
    def __init__(self, all_args):
        ...
        self.env_list = [Env(all_args, i) for i in range(all_args.n_eval_rollout_threads)]
